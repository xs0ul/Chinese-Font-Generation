...
class UNetDownBlock(nn.Module):
    def __init__(self, in_size, out_size, normalize=True, dropout=0.0):
        ...
        model += [nn.Conv2d(out_size, out_size, 3, stride=2, padding=1),
                  nn.LeakyReLU(0.2, inplace=True)]
...
class UNetUpBlock(nn.Module):
    def __init__(self, in_size, out_size, dropout=0.0):
        ...
        model += [nn.Conv2d(out_size, out_size, 3, stride=1, padding=1),
                  nn.LeakyReLU(0.2, inplace=True),
                  nn.BatchNorm2d(out_size)]
...
class GeneratorUNetBlock(nn.Module):
    def __init__(self, in_channels=3, out_channels=3):
        super(GeneratorUNetBlock, self).__init__()
...
class ResidualBlock(nn.Module):
    def __init__(self, in_features, dilation=1):
        super(ResidualBlock, self).__init__()

        conv_block = [nn.ReflectionPad2d(1),
                      nn.Conv2d(in_features, in_features, 3, dilation=dilation, padding=(dilation-1)),
